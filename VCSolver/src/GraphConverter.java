...
public class GraphConverter {
	...
	public int[][] rev;
	public int[] vertexID;
    public double mean_degree;

    /**
     * @param file [implicit] the input file
     * @return an array in which every pair of elements represents the vertex
     * numbers of the endpoints of an edge, so
     * [v_1, w_1, v_2, w_2, ..., v_m, w_m]
     * means that the edges are v_1-w_1, ..., v_m-w_m
     */
...
//  [Last modified: 2019 01 22 at 20:49:53 GMT]
