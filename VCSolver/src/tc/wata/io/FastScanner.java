...
public class FastScanner implements Closeable {
	...
	/**
	 * 現在の行を読み飛ばす．
     * Got rid of the check for negative chars - not clear why it's needed
     * and it causes problems when an input file has extended characters in
     * the comments. (Matthias Stallmann, 2019/01/22)
	 */
...
//  [Last modified: 2019 01 22 at 20:48:49 GMT]
